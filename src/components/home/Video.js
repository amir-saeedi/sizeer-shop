            ...
            <div>
                <div className="row">
                    <div className="col-sm-6 d-flex justify-content-center">
                        <div className="ih-item circle colored effect7 left_to_right card-story-main">
                            <a onClick={bagHandeler}>
                    ...
                    <div className="col-sm-6 d-flex justify-content-center">
                        <div className="ih-item circle colored effect7 right_to_left card-story-main">
                            <a onClick={bagHandeler}>
